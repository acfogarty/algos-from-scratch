...
# transition probabilities [ [p(C|C), p(C|H), p(C|START)], [p(H|C), p(H|H), p(H|START)], [p(STOP|C), p(STOP|H), p(STOP|START)], ]
p_transition = np.array([ [0.8, 0.2, 0.5], [0.2, 0.8, 0.5], [0.0, 0.0, 0] ])
